...
import com.goodjunseon.ajaxEX.dto.AjaxDTO;
...
public class AjaxController {
    ...
    @GetMapping("/ex05")
    public @ResponseBody AjaxDTO ex05(@ModelAttribute AjaxDTO ajaxDTO) { //@ModelAttribute 생략 가능하긴 하다.
    ...
    @PostMapping("/ex07")
    public @ResponseBody AjaxDTO ajaxDTO(@RequestBody AjaxDTO ajaxDTO) {
        System.out.println("ajaxDTO = " + ajaxDTO);
        return ajaxDTO;
    }
}
